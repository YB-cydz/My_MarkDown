...
>
> ***参考资料：[Kalman Filter Tutorial](https://www.kalmanfilter.net/)***
>
...
|(EKF)  $\mathbf{H}_n$|见下文[观测函数的一阶雅各比矩阵](##观测函数的一阶雅各比矩阵)|
...
| $\mathbf{H}_n$ (EKF) | 见下文[观测函数的一阶雅各比矩阵](##观测函数的一阶雅各比矩阵) |
...
|     $\mathbf{Q}_n$     | 是过程噪声矩阵                                   |
| $\mathbf{F}_n$ (EKF) | 见下文[转移函数的一阶雅各比矩阵](##转移函数的一阶雅各比矩阵) |

## 雅各比矩阵

$$
J = \frac{\partial(f_1, f_2, \dots, f_m)}{\partial(x_1, x_2, \dots, x_n)}=\begin{bmatrix}\frac{\partial f_1}{\partial x_1} & \frac{\partial f_1}{\partial x_2} & \cdots & \frac{\partial f_1}{\partial x_n} \\ 
...
$$
\mathbf{H}_n=\frac{\partial\mathbf{h}}{\partial\mathbf{x}}\big|_{\hat{\mathbf{x}}_{n,n-1}}
$$
...
$$
\mathbf{F}_n=\frac{\partial\mathbf{f}}{\partial\mathbf{x}}\big|_{\hat{\mathbf{x}}_{n,n},\mathbf{u}_n}
$$
